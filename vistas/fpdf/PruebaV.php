...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(110, 15, utf8_decode('TECNOLOGICO SAN AGUSTIN'), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(96, 10, utf8_decode("Ubicación : Carrera 6 # 33 - 02 Montería - Córdoba "), 0, 0, '', 0);
      $this->Ln(5);

      /* TELEFONO */
      $this->Cell(110);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(59, 10, utf8_decode("Teléfono : (604) 789 9888 - (604) 789 9899"), 0, 0, '', 0);
      $this->Ln(5);

      /* COREEO */
      $this->Cell(110);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(85, 10, utf8_decode("Correo : contacto@sanagustin.edu.co "), 0, 0, '', 0);
      $this->Ln(10);
      ...
      $this->Cell(100, 10, utf8_decode("HOJA DE VIDA DE EQUIPOS "), 0, 1, 'C', 0);
      $this->Ln(7);

      /* CAMPOS DE LA TABLA */
      //color
      $this->SetFillColor(131, 219, 245); //colorFondo
